...
In my previous blog post, [Consuming External Web Services](/blog/2018/egress-https/), I described how external services
 ...
 over TCP. You will use the [Istio Bookinfo sample application](/ko/docs/examples/bookinfo/), the version in which the book
 ...
 [Service Entry](/ko/docs/reference/config/networking/service-entry/) to allow the in-mesh applications to
...
[mutual TLS](/ko/docs/concepts/security/#mutual-tls-authentication) enabled.
...
of an Istio release archive. Edit the following lines:
    ...
    correct way to work with passwords in container's environment variables in Kubernetes is [to use secrets](https://kubernetes.io/ko/docs/concepts/configuration/secret/#using-secrets-as-environment-variables). For this
...
[the external services must be called directly](/ko/docs/tasks/traffic-management/egress/egress-control/#direct-access-to-external-services),
...
[Bookinfo with Virtual Machines](/ko/docs/examples/virtual-machines/bookinfo/) example. In that scenario, a MySQL instance runs on an
external
...
[mutual TLS authentication](/ko/docs/concepts/security/#mutual-tls-authentication). There is no need to create a service
...
[Istio VM-related](/ko/docs/examples/virtual-machines/) tasks for more details.
