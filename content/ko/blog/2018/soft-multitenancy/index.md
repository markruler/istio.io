...
limited multi-tenancy environment. The [docs](/ko/docs/) section will be updated
...
The Istio [sidecar](/ko/docs/setup/additional-setup/sidecar-injection/)
and [addons](/ko/docs/tasks/observability/), if required, manifests must also be
...
specific part. For the [Custom Resource Definitions](https://kubernetes.io/ko/docs/concepts/extend-kubernetes/api-extension/custom-resources/#customresourcedefinitions), the roles and the role
...
When defining [route rules](https://archive.istio.io/v0.7/ko/docs/reference/config/istio.routing.v1alpha1/#RouteRule)
or [destination policies](https://archive.istio.io/v0.7/ko/docs/reference/config/istio.routing.v1alpha1/#DestinationPolicy),
...
that tenant. As an example, updating the [Bookinfo](/ko/docs/examples/bookinfo/)
...
If the [add-on tools](/ko/docs/tasks/observability/), example
[Prometheus](/ko/docs/tasks/observability/metrics/querying-metrics/), are deployed
...
* Kubernetes documentation on [RBAC](https://kubernetes.io/ko/docs/reference/access-authn-authz/rbac/) and [namespaces](https://kubernetes.io/ko/docs/tasks/administer-cluster/namespaces-walkthrough/).
