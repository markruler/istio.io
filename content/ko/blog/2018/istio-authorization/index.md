...
[Istio's authorization feature](/ko/docs/concepts/security/#authorization), also known as Istio Role Based Access Control,
...
[combinations of attributes](/ko/docs/reference/config/security/conditions/).
...
[combinations of attributes](/ko/docs/reference/config/security/conditions/). This gives Istio
...
To improve security, you should enable [authentication features](/ko/docs/concepts/security/#authentication),
...
The [authorization task](/ko/docs/tasks/security/authorization/authz-http/) shows you how to
use Istio's authorization feature to control namespace level and service level access using the
[Bookinfo application](/ko/docs/examples/bookinfo/). In this section, you'll see more examples on how to achieve
...
[mutual TLS authentication](/ko/docs/concepts/security/#mutual-tls-authentication) for your mesh, you can use a
...
[JWT authentication](/ko/docs/concepts/security/#authentication). In this case, the combination of the client service identity
...
[Istio authentication features](/ko/docs/concepts/security/#authentication), Istio authorization can also be used to
