...
A [`Gateway`](/ko/docs/reference/config/networking/gateway/)
...
[`VirtualService`](/ko/docs/reference/config/networking/virtual-service/) resource.
For example, where previously we had two `RouteRule` resources for the
[Bookinfo](/ko/docs/examples/bookinfo/) application’s `reviews` service, like this:
...
A [`DestinationRule`](/ko/docs/reference/config/networking/destination-rule/)
...
[`ServiceEntry`](/ko/docs/reference/config/networking/service-entry/)
