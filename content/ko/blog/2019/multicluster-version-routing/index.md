...
can be demonstrated with simple [tasks](/ko/docs/tasks/) and [examples](/ko/docs/examples/)
...
[control plane model](/ko/docs/ops/deployment/deployment-models/#control-plane-models).
...
[traffic management](/ko/docs/concepts/traffic-management/), works in a multicluster mesh with
...
* Set up a multicluster environment with two Istio clusters by following the
    [replicated control planes](/ko/docs/setup/install/multicluster/gateways/) instructions.
...
* Follow the [Bookinfo sample instructions](/ko/docs/examples/bookinfo/#determine-the-ingress-ip-and-port)
...
As described in the [setup instructions](/ko/docs/setup/install/multicluster/gateways/#setup-dns),
...
Check out the
[gateway-connected multicluster example](/ko/docs/setup/install/multicluster/gateways/#configure-the-example-services)
for more details.
