...
[`v1beta1` authorization policy](/ko/docs/reference/config/security/authorization-policy/),
...
[authorization concept page](/ko/docs/concepts/security/#authorization)
...
An [`AuthorizationPolicy` custom resource](/ko/docs/reference/config/security/authorization-policy/)
...
[`MeshConfig`](/ko/docs/reference/config/istio.mesh.v1alpha1/#MeshConfig)
