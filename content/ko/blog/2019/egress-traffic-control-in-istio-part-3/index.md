...
1.  Support of [TLS](https://en.wikipedia.org/wiki/Transport_Layer_Security) with
    [SNI](https://en.wikipedia.org/wiki/Server_Name_Indication) or of [TLS origination](/ko/docs/reference/glossary/#tls-origination).
...
Kubernetes provides a native solution for traffic control, and in particular, for control of egress traffic, through the [network policies](https://kubernetes.io/ko/docs/concepts/services-networking/network-policies/).
...
apply
[additional security measures](/ko/docs/tasks/traffic-management/egress/egress-gateway/#additional-security-considerations),
...
-  Use Istio's [traffic management features](/ko/docs/concepts/traffic-management/) for egress traffic:
...
If you use [TLS egress traffic to wildcard domains](/ko/docs/tasks/traffic-management/egress/wildcard-egress-hosts/),
you must add
[an additional proxy](/ko/docs/tasks/traffic-management/egress/wildcard-egress-hosts/#wildcard-configuration-for-arbitrary-domains)
...
[traffic management](/ko/docs/tasks/traffic-management/), [security](/ko/docs/tasks/security/),
[policies](https://istio.io/v1.6/ko/docs/tasks/policy-enforcement/) and [observability](/ko/docs/tasks/observability/), applied to traffic between
microservices inside the cluster.

So, if you haven't had the chance to work with Istio yet, [install Istio](/ko/docs/setup/install/) on your cluster
and check our [egress traffic control tasks](/ko/docs/tasks/traffic-management/egress/) and the tasks for the other
[Istio features](/ko/docs/tasks/). We also want to hear from you, please join us at [discuss.istio.io](https://discuss.istio.io).
