...
The [Control Ingress Traffic](/ko/docs/tasks/traffic-management/ingress/ingress-control/) and the
[Ingress Gateway without TLS Termination](/ko/docs/tasks/traffic-management/ingress/ingress-sni-passthrough/) tasks describe
...
1.  Access the `httbin.org` service through your ingress IP and port which you stored in the
    ...
    [418 I'm a teapot](https://developer.mozilla.org/en-US/ko/docs/Web/HTTP/Status/418).
