...
metrics](https://istio.io/v1.6/ko/docs/reference/config/policy-and-telemetry/metrics) are augmented with
...
option can be configured via [mesh configuration](/ko/docs/reference/config/istio.mesh.v1alpha1/#MeshConfig-OutboundTrafficPolicy-Mode).
...
* **BlackHoleCluster** - The BlackHoleCluster is a virtual cluster created
  ...
  [service entries](/ko/docs/reference/config/networking/service-entry)
  are explicitly added for each service. To implement this, the default virtual
  outbound listener at `0.0.0.0:15001` which uses
  [original destination](https://www.envoyproxy.io/ko/docs/envoy/latest/intro/arch_overview/upstream/service_discovery#original-destination)
  ...
  The route is setup as [direct response](https://www.envoyproxy.io/ko/docs/envoy/latest/api-v2/api/v2/route/route_components.proto#envoy-api-field-route-route-direct-response)
...
* **PassthroughCluster** - The PassthroughCluster is a virtual cluster created
  ...
  This cluster uses the [original destination load balancing](https://www.envoyproxy.io/ko/docs/envoy/latest/intro/arch_overview/upstream/service_discovery#original-destination)
