...
higher-level APIs. [Knative Serving](https://knative.dev/ko/docs/serving/), a component of Knative that builds on Kubernetes and Istio to support deploying and
...
[Routes](https://github.com/knative/ko/docs/blob/master/ko/docs/serving/spec/knative-api-specification-1.0.md#route) object that supports revisions and traffic routing,
abstracting Istio’s [`VirtualService`](/ko/docs/reference/config/networking/virtual-service/) and [`DestinationRule`](/ko/docs/reference/config/networking/destination-rule/)
resources.
