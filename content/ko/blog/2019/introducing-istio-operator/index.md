...
Kubernetes [operators](https://kubernetes.io/ko/docs/concepts/extend-kubernetes/operator/) provide
...
Istio 1.4 introduces a new method of [installation using {{< istioctl >}}](/ko/docs/setup/install/istioctl/).
...
The [Helm installation](https://archive.istio.io/1.4/ko/docs/setup/install/helm/) method is in the process of deprecation. Upgrading from Istio
1.4 with a version not initially installed with Helm will also be replaced by a new
[{{< istioctl >}} upgrade feature](https://archive.istio.io/v1.4/ko/docs/setup/upgrade/istioctl-upgrade/).

The new `istioctl` installation commands use a
[custom resource](https://kubernetes.io/ko/docs/concepts/extend-kubernetes/api-extension/custom-resources/)
...
[custom resource definition (CRD)](https://kubernetes.io/ko/docs/concepts/extend-kubernetes/api-extension/custom-resources/#customresourcedefinitions)
to define its custom resource, that is, its API. Istio's operator API is defined by the
[`IstioControlPlane` CRD](https://archive.istio.io/v1.4/ko/docs/reference/config/istio.operator.v1alpha12.pb/),
...
The API supports all of Istio's current [configuration profiles](/ko/docs/setup/additional-setup/config-profiles/)
...
Refer to the Istio [install instructions](/ko/docs/setup/install/istioctl) for more details.
...
[available for experimentation](/ko/docs/setup/install/operator/) using `kubectl` commands.
...
See [Customize Istio settings using Helm](/ko/docs/setup/install/istioctl/#customize-istio-settings-using-the-helm-api)
for details.

Another feature to help with the transition from Helm is the alpha
[{{< istioctl >}} manifest migrate](/ko/docs/reference/commands/istioctl/#istioctl-manifest-migrate) command.
