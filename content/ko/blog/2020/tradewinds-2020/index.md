...
[adapters](https://istio.io/v1.6/ko/docs/reference/config/policy-and-telemetry/mixer-overview/#adapters)
...
Istio's [authentication](/ko/docs/concepts/security/#authentication-policies)
and [authorization](/ko/docs/concepts/security/#authorization) policies, which
...
proxy too - we have
[introduced in-proxy support](/ko/docs/reference/config/metrics)
...
[operator](https://kubernetes.io/ko/docs/concepts/extend-kubernetes/operator/)-based
installation. We introduced the
**[IstioOperator CRD and two installation modes](/ko/docs/setup/install/istioctl/)**:
...
[automated rollout of mutual TLS](/ko/docs/tasks/security/authentication/authn-policy/#auto-mutual-tls)
...
[Secret Discovery Service](https://www.envoyproxy.io/ko/docs/envoy/latest/configuration/security/secret)
