...
other through one or more [Istio gateways](/ko/docs/concepts/traffic-management/#gateways).
...
desirable to use [locality load balancing](/ko/docs/ops/configuration/traffic-management/locality-load-balancing)
...
Istio uses [namespaces](https://kubernetes.io/ko/docs/reference/glossary/?fundamental=true#term-namespace)
