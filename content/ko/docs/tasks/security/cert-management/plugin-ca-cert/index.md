---
title: CA 인증서 연결
description: 시스템 관리자가 루트 인증서, 서명 인증서, 키로 이스티오의 CA를 구성할 수 있는 방법을 보여 준다.
weight: 80
...
*   To remove the Istio components: follow the [uninstall instructions](/ko/docs/setup/getting-started/#uninstall) to remove.
