---
title: 인가 정책 트러스트 도메인 마이그레이션
description: 인가 정책을 변경하지 않고 한 트러스트 도메인에서 또 하나의 트러스트 도메인으로 마이그레이션하는 방법을 보여 준다.
weight: 60
...
1. Read the [authorization concept guide](/ko/docs/concepts/security/#authorization).
