...
aliases:
  - /ko/docs/examples/advanced-gateways/egress-gateway-tls-origination/
...
*   [Deploy Istio egress gateway](/ko/docs/tasks/traffic-management/egress/egress-gateway/#deploy-istio-egress-gateway).
...
1.  Send an HTTP request to [http://edition.cnn.com/politics](https://edition.cnn.com/politics).
    ...
    The output should be the same as in the [TLS Origination for Egress Traffic](/ko/docs/tasks/traffic-management/egress/egress-tls-origination/)
...
1. Create Kubernetes [Secrets](https://kubernetes.io/ko/docs/concepts/configuration/secret/) to hold the server's and CA
   certificates.
...
1. Create Kubernetes [Secrets](https://kubernetes.io/ko/docs/concepts/configuration/secret/) to hold the client's and CA
   certificates.
