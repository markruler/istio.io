...
weight: 50
aliases:
  - /ko/docs/examples/advanced-gateways/wildcard-egress-hosts/
owner: istio/wg-networking-maintainers
test: yes
---

The [Control Egress Traffic](/ko/docs/tasks/traffic-management/egress/) task and
the [Configure an Egress Gateway](/ko/docs/tasks/traffic-management/egress/egress-gateway/) example
...
*   Install Istio using the `demo` [configuration profile](/ko/docs/setup/additional-setup/config-profiles/)
    ...
    [deploy the Istio egress gateway](/ko/docs/tasks/traffic-management/egress/egress-gateway/#deploy-istio-egress-gateway),
    [enable Envoy’s access logging](/ko/docs/tasks/observability/logs/access-log/#enable-envoy-s-access-logging), and
    [apply the blocking-by-default outbound traffic policy](/ko/docs/tasks/traffic-management/egress/egress-control/#change-to-the-blocking-by-default-policy)
