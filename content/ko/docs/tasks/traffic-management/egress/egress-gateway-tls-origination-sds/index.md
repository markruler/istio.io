...
test: yes
aliases:
  - /ko/docs/examples/advanced-gateways/egress-gateway-tls-origination-sds/
---

The [TLS Origination for Egress Traffic](/ko/docs/tasks/traffic-management/egress/egress-tls-origination/)
example shows how to configure Istio to perform {{< gloss >}}TLS origination{{< /gloss >}}
for traffic to an external service. The [Configure an Egress Gateway](/ko/docs/tasks/traffic-management/egress/egress-gateway/)
...
*   Start the [sleep]({{< github_tree >}}/samples/sleep) sample
    ...
    If you have enabled [automatic sidecar injection](/ko/docs/setup/additional-setup/sidecar-injection/#automatic-sidecar-injection), do
...
*   [Deploy an Istio egress gateway](/ko/docs/tasks/traffic-management/egress/egress-gateway/#deploy-istio-egress-gateway).

*   [Enable Envoy’s access logging](/ko/docs/tasks/observability/logs/access-log/#enable-envoy-s-access-logging).

{{< tip >}}
 If you configured an egress gateway using the [file-mount based approach](/ko/docs/tasks/traffic-management/egress/egress-gateway-tls-origination),
...
[TLS Origination for Egress Traffic](/ko/docs/tasks/traffic-management/egress/egress-tls-origination/) example,
...
1.  Create a namespace to represent services outside the Istio mesh, namely `mesh-external`. Note that the sidecar proxy will
    ...
    [enabled](/ko/docs/setup/additional-setup/sidecar-injection/#deploying-an-app) on it.

    {{< text bash >}}
    $ kubectl create namespace mesh-external
    {{< /text >}}

1. Create Kubernetes [Secrets](https://kubernetes.io/ko/docs/concepts/configuration/secret/) to hold the server's and CA certificates.
...
1. Create Kubernetes [Secrets](https://kubernetes.io/ko/docs/concepts/configuration/secret/) to hold the server's certificates.
...
1.  Create Kubernetes [Secrets](https://kubernetes.io/ko/docs/concepts/configuration/secret/) to hold the client's certificates:
