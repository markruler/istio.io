...
aliases:
  - /ko/docs/examples/advanced-gateways/http-proxy/
owner: istio/wg-networking-maintainers
test: yes
---
The [Configure an Egress Gateway](/ko/docs/tasks/traffic-management/egress/egress-gateway/) example shows how to direct
