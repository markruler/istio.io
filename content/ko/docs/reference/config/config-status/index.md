...
[Wait for Resource Status to Apply Configuration](/ko/docs/ops/configuration/mesh/config-resource-ready/).
...
[Configuration Analysis Messages](/ko/docs/reference/config/analysis/).
