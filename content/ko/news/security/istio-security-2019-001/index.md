...
[Deny Checker](https://istio.io/v1.6/ko/docs/reference/config/policy-and-telemetry/adapters/denier/) and
[List Checker](https://istio.io/v1.6/ko/docs/reference/config/policy-and-telemetry/adapters/list/) feature were affected and those are considered stable features.
