...
Istio 1.3 to 1.3.7 and 1.4 to 1.4.3 are vulnerable to a newly discovered vulnerability affecting [Authentication Policy](https://archive.istio.io/1.4/ko/docs/reference/config/security/istio.authentication.v1alpha1/#Policy):
