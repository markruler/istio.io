...
[Learn more](https://istio.io/v0.6/ko/docs/reference/config/policy-and-telemetry/adapters/solarwinds/)

- **Redis Quota**. Mixer now supports a Redis-based adapter for rate limit tracking.
[Learn more](https://istio.io/v0.6/ko/docs/reference/config/policy-and-telemetry/adapters/redisquota/)

- **Datadog**. Mixer now provides an adapter to deliver metric data to a Datadog agent.
[Learn more](https://istio.io/v0.6/ko/docs/reference/config/policy-and-telemetry/adapters/datadog/)
