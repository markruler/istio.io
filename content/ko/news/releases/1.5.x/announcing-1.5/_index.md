...
[`istioctl`](/ko/docs/reference/commands/istioctl) is now beta for installation and
...
[Auto mTLS](/ko/docs/tasks/security/authentication/authn-policy/#auto-mutual-tls),
[`AuthenticationPolicy`](https://archive.istio.io/1.4/ko/docs/reference/config/security/istio.authentication.v1alpha1/)
