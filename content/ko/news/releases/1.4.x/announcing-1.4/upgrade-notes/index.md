...
See [Protocol Selection](/ko/docs/ops/configuration/traffic-management/protocol-selection/) for more information about specifying the protocol of a port
...
* Use the [reference documentation](/ko/docs/reference/config/) to confirm and correct the field names and data types.
* In addition to structural validation, you can also use `istioctl x analyze` to help you detect other potential issues with your Istio configurations. Refer to [here](/ko/docs/ops/diagnostic-tools/istioctl-analyze/) for more details.
...
[authorization policy](/ko/docs/reference/config/security/authorization-policy/).
