...
[Egress Gateways that do TLS/mTLS origination](/ko/docs/tasks/traffic-management/egress/egress-gateway-tls-origination-sds/)
...
in the [`MeshConfig` resource](/ko/docs/reference/config/istio.mesh.v1alpha1/#MeshConfig).
...
the ability of the very useful [istioctl analyze tool](/ko/docs/ops/diagnostic-tools/istioctl-analyze/):
...
The [Istio Operator](/ko/docs/setup/install/operator/)
...
Istio. Unfortunately, you couldn't use them together - [until now](/ko/docs/setup/upgrade/#canary-upgrades).
...
the mesh](/ko/docs/setup/install/virtual-machine/) get a [secure bootstrapping
