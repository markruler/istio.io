...
weight: 20
aliases:
    - /ko/docs/setup/kubernetes/upgrade/notice/
    - /ko/docs/setup/upgrade/notice
---
...
previous behavior. To learn more see our [protocol selection page](/ko/docs/ops/configuration/traffic-management/protocol-selection/).

To specify a hostname in multiple namespaces, you must select a single host using
a [`Sidecar` resource](/ko/docs/reference/config/networking/sidecar/).
