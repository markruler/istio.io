...
One of our prime areas of focus has been [performance and scalability](/ko/docs/ops/deployment/performance-and-scalability/).
...
[sidecars](/ko/docs/concepts/traffic-management/#sidecars) took too many resources
and added too much latency. The control plane (especially
[Pilot](/ko/docs/ops/deployment/architecture/#pilot)) was overly
resource hungry.
...
results in our updated [performance ans scalability concept](/ko/docs/ops/deployment/performance-and-scalability/).
...
We have also improved the [multicluster capabilities and usability](/ko/docs/ops/deployment/deployment-models/).
We listened to the community and improved defaults for traffic control and
policy. We introduced a new component called
[Galley](https://archive.istio.io/v1.1/ko/docs/concepts/what-is-istio/#galley). Galley validates that sweet,
sweet YAML, reducing the chance of configuration errors. Galley will also be
instrumental in [multicluster setups](/ko/docs/setup/install/multicluster/),
...
[control plane models](/ko/docs/ops/deployment/deployment-models/#control-plane-models)
...
So: now’s the time! Grab 1.1, check out [the updated documentation](/ko/docs/),
[install it](/ko/docs/setup/) and...happy meshing!
