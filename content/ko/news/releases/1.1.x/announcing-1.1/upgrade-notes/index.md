...
Istio to evolve beyond a Helm-based installation.  The [upgrade documentation](/ko/docs/setup/upgrade/) provides the proper procedures for upgrading
...
- The 1.0 `istio-remote` chart used for [multicluster VPN](https://archive.istio.io/v1.1/ko/docs/setup/kubernetes/install/multicluster/vpn/) and
[multicluster split horizon](https://archive.istio.io/v1.1/ko/docs/examples/multicluster/split-horizon-eds/) remote cluster
...
Ingress Gateway, please follow the [Remotely Accessing Telemetry Addons](/ko/docs/tasks/observability/gateways/) guide.
...
`--set global.k8sIngress.enabled=true` flag.  Check out [Securing Kubernetes Ingress with Cert-Manager](/ko/docs/ops/integrations/certmanager/)
...
to [Migrating `RbacConfig` to `ClusterRbacConfig`](https://archive.istio.io/v1.1/ko/docs/setup/kubernetes/upgrade/steps/#migrating-from-rbacconfig-to-clusterrbacconfig) for migration instructions.
